...
<template>
  <div class="bg-white rounded-lg p-5 shadow-md">
    ...
    <!-- Form -->
    <vee-form :validation-schema="schema" @submit="StoreSalary" validate-on-input enctype="multipart/form-data">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div>
          ...
          <vee-field type="date" name="date" id="salary-date" v-model="formData.date" class="block w-full p-2.5 rounded-md border border-gray-200 bg-gray-100 focus:outline-1 focus:outline-mainColor cursor-pointer"></vee-field>
        ...
        <div>
          ...
          <vee-field as="select" name="month" id="salary-month" v-model="formData.month" class="block w-full p-2.5 rounded-md border border-gray-200 bg-gray-100 focus:outline-1 focus:outline-mainColor cursor-pointer">
        ...
        <div>
          ...
          <vee-field as="select" name="year" id="salary-year" v-model="formData.year" class="block w-full p-2.5 rounded-md border border-gray-200 bg-gray-100 focus:outline-1 focus:outline-mainColor cursor-pointer">
      ...
      <div>
        ...
        <vee-field as="select" name="type" id="salary-type" v-model="formData.type" class="block w-full p-2.5 rounded-md border border-gray-200 bg-gray-100 focus:outline-1 focus:outline-mainColor cursor-pointer">
