...
/** All Instance */
PageName.value = 'Create Expense Category';
...
<template>
    <div class="bg-white rounded-lg p-5 shadow-md">
        ...
        <!-- Form -->
        <vee-form :validation-schema="schema" @submit="StoreExpenseCategory" validate-on-input>
            ...
            <div>
                ...
                <vee-field type="text" name="category_name" id="category-name" v-model="formData.category_name" class="block w-full p-2.5 rounded-md border border-gray-200 bg-gray-100 focus:outline-1 focus:outline-mainColor placeholder:text-sm" placeholder="Expense Category Name" required />
