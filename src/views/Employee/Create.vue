...
/** All Instance */
PageName.value = 'Create Employee';
...
/** All Methods */
const StoreEmployee = () => {
    employeeStore.storeEmployee(formData);
};
...
<template>
    <div class="bg-white rounded-lg p-5 shadow-md">
        ...
        <!-- Form -->
        <vee-form :validation-schema="schema" @submit="StoreEmployee" validate-on-input enctype="multipart/form-data">
