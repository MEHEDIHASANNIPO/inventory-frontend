    ...
    <div class="bg-white rounded-lg p-5 shadow-md">
        ...
        <vee-form :validation-schema="schema" @submit="UpdatePermission" validate-on-input>
            ...
            <div>
                ...
                <vee-field as="select" name="module_id" id="module-name" v-model="permissionStore.editFormData.module_id" class="block w-full p-2.5 rounded-md border border-gray-200 bg-white cursor-pointer focus:outline-1 focus:outline-mainColor">
            ...
            <div class="mt-4">
                ...
                <vee-field type="text" name="permission_name" id="permission-name" v-model="permissionStore.editFormData.permission_name" class="block w-full p-2.5 rounded-md border border-gray-200 bg-white focus:outline-1 focus:outline-mainColor placeholder:text-sm" placeholder="Permission Name" required />
